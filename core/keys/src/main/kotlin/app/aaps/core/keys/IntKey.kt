...
enum class IntKey(
    ...
    ApsWaveMaxMinutesOfBasalToLimitSmb("wavesmbmaxminutes", 60, 15, 300, defaultedBySM = true, dependency = BooleanKey.ApsWaveEnable, negativeDependency = BooleanKey.ApsWaveUseSMBCap),
